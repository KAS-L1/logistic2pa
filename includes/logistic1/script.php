<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        ...
        <!-- <script>
                ...
                document.getElementById('logisticDropdown').addEventListener('mouseenter', function () {
                        ...
                        toggle: true // Ensure it toggles when hovered
                        });
                });

                // Optional: Close dropdown when the mouse leaves the dropdown area
                document.getElementById('collapseDashboard').addEventListener('mouseleave', function () {
                        var collapseElement = new bootstrap.Collapse(document.getElementById('collapseDashboard'), {
