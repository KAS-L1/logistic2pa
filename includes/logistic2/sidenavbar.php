        ...
        <div class="nav">
            ...
            <div class="collapse" id="collapseDashboard" aria-labelledby="headingDashboard" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="/sub-modules/logistic2/procurement.php">Procurement &<br>Vendor</a>
                    <a class="nav-link" href="/sub-modules/logistic2/auditmanagement.php">Audit<br>Management</a>
                    <a class="nav-link" href="/sub-modules/logistic2/documenttracking.php">Document<br>Tracking</a>
                </nav>
            </div>
