<div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <a class="nav-link collapsed" href="#" id="logisticDropdown" data-bs-toggle="collapse" data-bs-target="#collapseDashboard" aria-expanded="false" aria-controls="collapseDashboard">
            ...
            <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseProjectManagement" aria-expanded="false" aria-controls="collapseProjectManagement">
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseVehicleReservation" aria-expanded="false" aria-controls="collapseVehicleReservation">
                    <div class="sb-nav-link-icon"><i class="fas fa-tasks"></i></div>
                    Document Tracking
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
        ...
        <a class="nav-link" href="scrumboard.php">
            <div class="sb-nav-link-icon"><i class="fas fa-tasks"></i></div>
            Scrumboard
        </a>
